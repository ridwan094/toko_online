...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <img src="../foto/<?php echo $value["nama_produk_foto"] ?>" alt="" class="img-responsive"><br>
        <a href="index.php?halaman=hapusfotoproduk&idfoto=<?php echo $value["id_produk_foto"] ?>&idproduk=<?php echo $id_produk ?>" class="btn-danger btn-sm btn">Hapus</a>
    </div>
    <?php endforeach ?>
</div>
...
<form method="post" enctype="multipart/form-data">
    ...
    <button class="btn-primary btn" name="simpan" value="simpan">Simpan</button>
</form>
